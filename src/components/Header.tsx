      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/professional">Professional</MobileNavItem>
            <MobileNavItem href="/athletics">Athletics</MobileNavItem>
            <MobileNavItem href="/kelevel">KeLevel</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/professional">Professional</NavItem>
        <NavItem href="/athletics">Athletics</NavItem>
        <NavItem href="/kelevel">KeLevel</NavItem>
      </ul>
    </nav>
  )
}
...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        'h-[68px] w-[68px] rounded-full bg-white/90 p-0.5 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:ring-white/10',
      )}
      {...props}
    />
  )
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <Avatar
                    large
                    className="block h-28 w-28 origin-left"
